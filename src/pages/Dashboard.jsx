  ...
  return (
    <div className="flex flex-col mt-2 ">
      <div className="flex md:justify-around items-center mx-auto md:gap-40 my-3 md:text-lg text-center flex-col sm:flex-row text-sm justify-between gap-4">
        <div className="shadow-lg shadow-cyan-300 px-5 py-10 rounded-xl border-sky-300 border-2 h-48">
          <ul>
            <li>Save your memories on map</li>
            <li>To remember them forever</li>
          </ul>
        </div>
        <div className="shadow-lg shadow-sky-300 px-5 py-10 rounded-xl border-sky-300 border-2 h-48">
      ...
      <div className="flex justify-between items-center text-xl border-4 border-sky-700 rounded-xl py-7 text-center flex-col md:flex-row my-3">
